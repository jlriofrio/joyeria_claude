...
export default function ContactPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      content: whatsappNumber ? `+${whatsappNumber}` : t.contact.availableOnRequest,
  ...
  return (
    <main className="bg-ivory">
      ...
      <section className="relative h-[45vh] sm:h-[55vh] flex items-end overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-6 pb-14 sm:pb-18 w-full">
          <span className="text-gold text-xs tracking-[6px] uppercase font-sans block mb-4 sm:mb-5">
            — {t.contact.heroEyebrow}
          </span>
          <h1 className="font-heading text-5xl sm:text-7xl md:text-8xl font-light text-white leading-[0.92]">
            {t.contact.heroTitle}
          </h1>
        </div>
        ...
        <div className="grid md:grid-cols-5 gap-12 md:gap-16 items-start">
          ...
          <Reveal className="md:col-span-2">
            <span className="text-gold text-xs tracking-[6px] uppercase font-sans">
              {t.contact.infoEyebrow}
            </span>
            <h2 className="font-heading text-3xl sm:text-4xl font-light mt-3 mb-6 text-obsidian">
              {t.contact.infoTitle}
            </h2>
          ...
          <Reveal delay={120} className="md:col-span-3">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl font-light mt-3 mb-8 text-obsidian">
              {t.contact.formTitle}
            </h2>
            <ContactForm />
          </Reveal>
      ...
      {/* WHATSAPP CTA */}
      <section className="bg-obsidian py-16 sm:py-20 px-5 sm:px-6 relative overflow-hidden">
        <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-gold/30 to-transparent" />

        <div className="max-w-3xl mx-auto text-center">
          <span className="text-gold text-xs tracking-[6px] uppercase font-sans">
            {t.contact.whatsCtaEyebrow}
          </span>
          <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl font-light text-white mt-4 mb-4">
            {t.contact.whatsCtaTitle}
          </h2>
          <div className="w-8 h-px bg-gold mx-auto mb-6" />
          <p className="text-white/55 mb-10 font-sans text-sm leading-relaxed">
            {t.contact.whatsCtaText}
          </p>
          ...
          {whatsappHref ? (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 bg-green-600 text-white px-8 sm:px-10 py-4 text-xs tracking-[4px] uppercase hover:bg-green-500 transition-colors duration-300"
            >
            ...
            <p className="text-white/50 font-sans text-sm">{t.contact.fallback}</p>
          )}
        </div>
      </section>
