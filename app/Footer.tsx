...
const categories = [
  { href: "/catalogo/anillos", key: "Anillos" },
  { href: "/catalogo/cadena", key: "Cadena" },
  { href: "/catalogo/aretes", key: "Aretes" },
  { href: "/catalogo/argollas", key: "Argollas" },
  { href: "/catalogo/pulseras", key: "Pulseras" },
] as const;
...
export default function Footer() {
  ...
  return (
    <footer className="bg-obsidian border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 pt-14 sm:pt-16 pb-10">

        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-10 sm:gap-12 mb-12 sm:mb-14">
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-4 font-sans">
              <li className="flex items-start gap-2">
                ...
                <span className="text-white/45 text-sm">{t.footer.location}</span>
              </li>
              {whatsappHref && (
                <li>
                  <a
              ...
              <li className="pt-1">
                <p className="text-[10px] tracking-[3px] uppercase text-white/25 mb-1">
                  {t.footer.scheduleLabel}
                </p>
                <p className="text-white/45 text-sm">{t.footer.weekdays}</p>
                <p className="text-white/45 text-sm">{t.footer.saturday}</p>
              </li>
            </ul>
          </div>
        </div>
        ...
        {/* DIVIDER */}
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row items-center justify-between gap-3 text-center">
