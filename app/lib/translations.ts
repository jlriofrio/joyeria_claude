...
export const translations = {
  es: {
    ...
    home: {
      ...
      collectionsTitle: "Nuestras",
      collectionsTitleAccent: "joyas",
      featuredCategories: [
        { name: "Anillos", description: "Diseños únicos en oro y plata" },
        { name: "Cadenas", description: "Elaboradas artesanalmente" },
        { name: "Aretes", description: "Elegancia en cada detalle" },
      ],
      viewFullCatalog: "Ver catálogo completo",
      valuesEyebrow: "Por qué elegirnos",
      valuesTitle: "Nuestra",
      valuesTitleAccent: "esencia",
      values: [
        {
          title: "Tradición",
      ...
      historyTitleLine1: "Familia de",
      historyTitleAccent: "orfebres",
      historyTitleLine2: "desde 1987",
      historyText:
      ...
      ctaEyebrow: "Cotización gratuita",
      ctaTitleLine1: "¿Lista para tu",
      ctaTitleAccent: "joya perfecta?",
      ctaText:
  ...
  en: {
    ...
    home: {
      ...
      collectionsTitle: "Our",
      collectionsTitleAccent: "jewelry",
      featuredCategories: [
        { name: "Rings", description: "Unique designs in gold and silver" },
        { name: "Chains", description: "Handcrafted with care" },
        { name: "Earrings", description: "Elegance in every detail" },
      ],
      viewFullCatalog: "View full catalog",
      valuesEyebrow: "Why choose us",
      valuesTitle: "Our",
      valuesTitleAccent: "essence",
      values: [
        {
          title: "Tradition",
          desc: "More than 35 years of family artistry passed down through generations from Cali, Colombia.",
        },
        {
          title: "Quality",
          desc: "We use only the finest materials: 18K gold, 950 silver, and carefully selected gemstones.",
        },
        {
          title: "Exclusivity",
          desc: "Every piece is one of a kind, created especially for you with love and artisan dedication.",
        },
      ],
      ...
      historyTitleLine1: "A family of",
      historyTitleAccent: "goldsmiths",
      historyTitleLine2: "since 1987",
      historyText:
        "We were born from the passion of a married couple of goldsmiths from Cali who devoted their lives to the art of jewelry. Today, with more than 35 years of experience, we still craft every piece with the same love and care as on day one.",
      historyLink: "Discover our story",
      yearsBadge: "years of experience",
      ctaEyebrow: "Free quote",
      ctaTitleLine1: "Ready for your",
      ctaTitleAccent: "perfect jewel?",
      ctaText:
        "Tell us your idea and we'll make it real. We design custom gold and silver jewelry with the artisan quality you deserve.",
